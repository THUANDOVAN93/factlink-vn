<?php
	...
	if ($bactype == 'bsc') { $posleft = "disabled"; $posright = "disabled"; $poscheck = ""; $bacwidth = "180"; $bacheight = "86"; $spcdisable = "disabled"; }
	else { $posleft = ""; $posright = ""; $poscheck = "checked"; $bacwidth = "180"; $bacheight = "86"; }
