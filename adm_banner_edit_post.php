<?php
	...
	$sql1 = "update flc_banner set mem_id = '$t_member', ban_name = '$t_name', ban_page = '$t_pospage', ban_side = '$t_posside', ban_link_en = '$t_link_en', ban_link_jp = '$t_link_jp', ban_link_vn = '$t_link_vn', ban_package = '$t_package', ban_startdate = '$startdate', ban_enddate = '$enddate', ban_preenddate = '$preenddate', ban_expirewarning = '$warning', ban_sort = '$bansort', ban_status = '$banstatus' where ban_id = '$h_banid';";
