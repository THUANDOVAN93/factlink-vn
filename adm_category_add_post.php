<?php
	...
	$sql1 = "insert into flc_category (cat_name_en, cat_name_jp, cat_name_vn, cat_pos, cat_under, cat_order) values ('$t_name_en', '$t_name_jp', '$t_name_vn', '$t_pos', '$t_under', '$catorder');";
