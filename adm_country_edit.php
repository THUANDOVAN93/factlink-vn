<?php 
	...
	while ($dbarr1 = mysql_fetch_array($result1)) {
		...
		$ctynameen = $dbarr1['cty_name_en']; 
		$ctynamejp = $dbarr1['cty_name_jp']; 
		$ctynamevn = $dbarr1['cty_name_vn']; 
		
	}
	
	$tpl->assign("##admid##", $_SESSION['vd']);
	$tpl->assign("##ctyid##", $ctyid);
	$tpl->assign("##ctynameen##", $ctynameen);
	$tpl->assign("##ctynamejp##", $ctynamejp);
	$tpl->assign("##ctynamevn##", $ctynamevn);
