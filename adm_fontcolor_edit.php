<?php 
	...
	$sql1 = "select * from flc_color_font where clf_id = '$clfid';"; 
	$result1 = mysql_query($sql1);
	while ($dbarr1 = mysql_fetch_array($result1)) {
		
		$clfnameen = $dbarr1['clf_name_en']; 
	...
	$tpl->assign("##clfnameen##", $clfnameen);
