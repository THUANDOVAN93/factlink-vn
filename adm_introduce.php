<?php 
	...
	$pagesql = "select * from flc_introduce;";
	$page = pagecal($limit, $start, $pagesql, "adm_introduce.php", "");
	
	$sql1 = "select * from flc_introduce order by int_id desc limit $start,$limit;";
	...
	while ($dbarr1 = mysql_fetch_array($result1)) {
		...
		$intid = $dbarr1['int_id'];
		$intdate = $dbarr1['int_date'];
		
		$tpl->assign("##intid##", $intid);
		$tpl->assign("##intname##", $intname);
		$tpl->assign("##intdate##", $intdate);
