<?php
	...
	if ($h_langcode == 'en') {
		...
		$sql1 = "
			insert into flc_present_box (
				...
				'$h_memid',
				'$h_pagid', '$t_boxsort', '$t_boxstatus', '$t_box1', '$t_clf1', '$t_title1', '$t_detail1',
	...
	// exit("$sql1");
	$result1 = mysql_query($sql1) or die('flc_present_box');
	...
	echo "<meta http-equiv = \"refresh\" content = \"0;URL = adm_member_page_box_add.php?id=$h_memid&page=$h_pagid&lang=$h_langcode\">";
