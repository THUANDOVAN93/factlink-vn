<?php 
	...
	$url2 = "adm_member_page_column_edit.html";
	...
	while ($dbarr2 = mysql_fetch_array($result2)) {
		...
		$convideolink = htmlentities($dbarr2['con_video_link']);
		$conmedia_option = $dbarr2['con_media_option'];
	...
	$tpl->assign("##convideolink##", $convideolink);
