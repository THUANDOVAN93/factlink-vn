<?php 
	...
	$url2 = "adm_member_page_present_add.html";
	...
	$sql4 = "select * from flc_page where mem_id = '$memid' and pag_type = 'pst';"; 
	$result4 = mysql_query($sql4);
	while ($dbarr4 = mysql_fetch_array($result4)) { $pagid = $dbarr4['pag_id']; }
	
	if ($pagid != '') { echo "<meta http-equiv = \"refresh\" content = \"0;URL = edt_page_present_edit.php?page=$pagid&lang=$langcode\">"; exit(); }
