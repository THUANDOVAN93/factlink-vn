<?php
	...
	$sql2 = "update flc_present set pst_template = '$t_tpk' where pag_id = '$h_pagid';";
	...
	if ($t_imagedisable == 't') {
		$sql5 = "update flc_page set pag_image = '', pag_image_width = '', pag_image_link = '', pag_image_side = '' where pag_id = '$h_pagid';";
	} else {
