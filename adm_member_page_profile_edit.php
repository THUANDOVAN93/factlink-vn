<?php 
	...
	//id=00001433&page=00002033&lang=vn
	if($_SESSION['repage']!=time()){echo "<meta http-equiv = \"refresh\" content = \"0;URL = adm_member_page_profile_edit.php?id=".$_GET['id']."&page=".$_GET['page']."&lang=".$_GET['lang']."\">";$_SESSION['repage']=time(); exit();}
	include_once("./include/class.rFastTemplate.php");
	include_once("./include/global_config.php");
	include_once("./include/global_function.php");
	
	$url1 = "adm_structure.html"; 
	$url2 = "adm_member_page_profile_edit.html";
	...
	while ($dbarr2 = mysql_fetch_array($result2)) {
		...
		$memcomnameaka = stripslashes($dbarr2['mem_comname_aka']);
		...
		$memtel4 = stripslashes($dbarr2['mem_telnum4']);
	...
	$tpl->assign("##memcomname##", $memcomname);
	$tpl->assign("##memcomnameaka##", $memcomnameaka);
