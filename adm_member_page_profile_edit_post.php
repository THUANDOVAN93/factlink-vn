<?php
	...
	if ($h_langcode == 'en') {
		...
		// echo "<pre>".print_r($t_pagdetail,true)."</pre>"; exit;
		
		
		$sql1 = "update flc_page set pag_show_en = '$t_setlang', pag_name_en = '$t_pagname', pag_pagetitle_en = '$t_pagpagetitle', pag_title_color = '$t_clf', pag_profile_color = '$t_clfdetail', 
		...
		$sql1 = "update flc_page set pag_show_vn = '$t_setlang', pag_name_vn = '$t_pagname', pag_pagetitle_vn = '$t_pagpagetitle', pag_title_color = '$t_clf', pag_profile_color = '$t_clfdetail', 
		...
		$sql1 = "update flc_page set pag_show_jp = '$t_setlang', pag_name_jp = '$t_pagname', pag_pagetitle_jp = '$t_pagpagetitle', pag_title_color = '$t_clf', pag_profile_color = '$t_clfdetail', 
