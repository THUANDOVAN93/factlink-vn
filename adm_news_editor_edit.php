<?php 
	...
	$url2 = "adm_news_editor_edit.html";
	...
	$sql1 = "select * from flc_news_editor where nwe_id = '$nweid';"; 
	$result1 = mysql_query($sql1);
	while ($dbarr1 = mysql_fetch_array($result1)) {
		
		$nwenameen = $dbarr1['nwe_name_en']; 
		$nwenamejp = $dbarr1['nwe_name_jp']; 
		$nwenamevn = $dbarr1['nwe_name_vn']; 
		
	}
	
	$tpl->assign("##admid##", $_SESSION['vd']);
	$tpl->assign("##nweid##", $nweid);
	$tpl->assign("##nwenameen##", $nwenameen);
	$tpl->assign("##nwenamejp##", $nwenamejp);
	$tpl->assign("##nwenamevn##", $nwenamevn);
