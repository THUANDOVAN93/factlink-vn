<?php 
	...
	$sql1 = "select * from flc_news_genre where nwg_id = '$nwgid';"; 
	$result1 = mysql_query($sql1);
	while ($dbarr1 = mysql_fetch_array($result1)) {
		
		$nwgnameen = $dbarr1['nwg_name_en']; 
		$nwgnamejp = $dbarr1['nwg_name_jp']; 
		$nwgnamevn = $dbarr1['nwg_name_vn']; 
		
	}
	
	$tpl->assign("##admid##", $_SESSION['vd']);
	$tpl->assign("##nwgid##", $nwgid);
	$tpl->assign("##nwgnameen##", $nwgnameen);
	$tpl->assign("##nwgnamejp##", $nwgnamejp);
	$tpl->assign("##nwgnamevn##", $nwgnamevn);
