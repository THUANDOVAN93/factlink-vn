<?php 
	...
	$sql1 = "select * from flc_pattern_content where ptc_id = '$ptcid';"; 
	$result1 = mysql_query($sql1);
	while ($dbarr1 = mysql_fetch_array($result1)) {
		
		$ptcnameen = $dbarr1['ptc_name_en']; 
		
	}
	
	$tpl->assign("##admid##", $_SESSION['d']);
	$tpl->assign("##ptcid##", $ptcid);
	$tpl->assign("##ptcnameen##", $ptcnameen);
