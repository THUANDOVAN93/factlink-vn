<?php 
	...
	$sql1 = "select * from flc_province where prv_id = '$prvid';"; 
	$result1 = mysql_query($sql1);
	while ($dbarr1 = mysql_fetch_array($result1)) {
		
		$prvnameen = $dbarr1['prv_name_en']; 
		$prvnamejp = $dbarr1['prv_name_jp']; 
		$prvnamevn = $dbarr1['prv_name_vn']; 
		
	}
	
	$tpl->assign("##admid##", $_SESSION['vd']);
	$tpl->assign("##prvid##", $prvid);
	$tpl->assign("##prvnameen##", $prvnameen);
	$tpl->assign("##prvnamejp##", $prvnamejp);
	$tpl->assign("##prvnamevn##", $prvnamevn);
