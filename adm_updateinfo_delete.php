<?php 
	...
	$url2 = "adm_updateinfo_delete.html";
	...
	while ($dbarr1 = mysql_fetch_array($result1)) { 
		...
		if ($_COOKIE['vlang'] == 'en') { $uifdetail = $dbarr1['uif_detail_en']; }
		else if ($_COOKIE['vlang'] == 'vn') { $uifdetail = $dbarr1['uif_detail_vn']; }
		else { $uifdetail = $dbarr1['uif_detail_jp']; }
	}
