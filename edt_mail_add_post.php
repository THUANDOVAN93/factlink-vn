<?php
	...
	if ($_SESSION['vmd'] != $h_memid) {
		echo "<meta http-equiv = \"refresh\" content = \"0;URL = error.php?code=2\">";
		exit();
	}

	$sql1 = "insert into flc_mail (mem_id, mal_to_name, mal_to_mail, mal_subj, mal_detail, mal_date, mal_time, mal_ip, mal_box) values ('$h_memid', '$t_to', '$t_mail', '$t_subject', '$t_detail', '$nowdate', '$nowtime', '$getip', 'o');";
