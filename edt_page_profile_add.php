<?php 
	...
	$url2 = "edt_page_profile_add.html";
	...
	while ($dbarr3 = mysql_fetch_array($result3)) { $prfid = $dbarr3['prf_id']; }*/
	...
	if ($pagid != '') { echo "<meta http-equiv = \"refresh\" content = \"0;URL = edt_page_profile_edit.php?page=$pagid&lang=$langcode\">"; exit(); }
	
	$sql1 = "select * from flc_member where mem_id = '$memid';"; 
	$result1 = mysql_query($sql1);
	while ($dbarr1 = mysql_fetch_array($result1)) {
	
		$memcomnameen = stripslashes($dbarr1['mem_comname_en']);
		$memcomnamejp = stripslashes($dbarr1['mem_comname_jp']);
		$memcomnamevn = stripslashes($dbarr1['mem_comname_vn']);
		$memaddress1en = stripslashes($dbarr1['mem_address1_en']);
		$memaddress1jp = stripslashes($dbarr1['mem_address1_jp']);
		$memaddress1vn = stripslashes($dbarr1['mem_address1_vn']);
		$memaddressine1 = stripslashes($dbarr1['mem_addressine1']);
		$memaddressprv1 = stripslashes($dbarr1['mem_addressprv1']);
		$memaddresscty1 = stripslashes($dbarr1['mem_addresscty1']); 
		$memaddresszip1 = stripslashes($dbarr1['mem_addresszip1']);
		$memcomtel = stripslashes($dbarr1['mem_comtel']);
		$memconnameen = stripslashes($dbarr1['mem_contactname_en']);
		$memconnamejp = stripslashes($dbarr1['mem_contactname_jp']);
		$memconnamevn = stripslashes($dbarr1['mem_contactname_vn']);
		$memconposen = stripslashes($dbarr1['mem_contactposition_en']);
		$memconposjp = stripslashes($dbarr1['mem_contactposition_jp']);
		$memconposvn = stripslashes($dbarr1['mem_contactposition_vn']);
