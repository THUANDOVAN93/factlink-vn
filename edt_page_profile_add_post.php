<?php
	...
	$t_establish = $_POST['t_establishdate'];
	...
	$t_footer = str_replace('\\r\\n','[br]',stripcslashes($t_footer));
	...
	while ($dbarr6 = mysql_fetch_array($result6)) {
		$memcomnameen = addslashes($dbarr6['mem_comname_en']);
		$memcomnamejp = addslashes($dbarr6['mem_comname_jp']);
		$memcomnamevn = addslashes($dbarr6['mem_comname_vn']);
		$memfolder = addslashes($dbarr6['mem_folder']);
	}
