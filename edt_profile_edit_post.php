<?php
	...
	$t_comname_en = addslashes($_POST['t_comname_en']);
	$t_comname_jp = addslashes($_POST['t_comname_jp']);
	$t_comname_vn = addslashes($_POST['t_comname_vn']);
	$t_memsubdesc_en = addslashes($_POST['t_memsubdesc_en']);
	$t_memsubdesc_jp = addslashes($_POST['t_memsubdesc_jp']);
	$t_memsubdesc_vn = addslashes($_POST['t_memsubdesc_vn']);
	$t_memcat = addslashes($_POST['t_memcat']);
	$t_comie = addslashes($_POST['t_comie']);
	$t_comaddress_en = addslashes($_POST['t_comaddress_en']);
	$t_comaddress_jp = addslashes($_POST['t_comaddress_jp']);
	$t_comaddress_vn = addslashes($_POST['t_comaddress_vn']);
	$t_comprovince = addslashes($_POST['t_comprovince']);
	$t_comcountry = addslashes($_POST['t_comcountry']);
	$t_comzip = addslashes($_POST['t_comzip']);
	$t_comtel = addslashes($_POST['t_comtel']);
	$t_comfax = addslashes($_POST['t_comfax']);
	$t_contact_en = addslashes($_POST['t_contact_en']);
	$t_contact_jp = addslashes($_POST['t_contact_jp']);
	$t_contact_vn = addslashes($_POST['t_contact_vn']);
	$t_position_en = addslashes($_POST['t_position_en']);
	$t_position_jp = addslashes($_POST['t_position_jp']);
	$t_position_vn = addslashes($_POST['t_position_vn']);
	$t_gender = $_POST['t_gender'];
	$t_mail = $_POST['t_mail'];
	$oth_contactmail = $_POST['t_oth_contactmail'];
	$t_tel = $_POST['t_tel'];
	...
	$sql1 = "update flc_member set mem_category = '$t_memcat', mem_comname_en = '$t_comname_en', mem_comname_jp = '$t_comname_jp', mem_comname_vn = '$t_comname_vn',
					...
					mem_contactposition_vn = '$t_position_vn', mem_contactgender = '$t_gender', mem_contactmail = '$t_mail', mem_oth_contactmail= '$oth_contactmail', mem_contacttel = '$t_tel', mem_sort = '$h_memsort'
