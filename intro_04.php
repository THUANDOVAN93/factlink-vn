<?php 
	...
	$url5 = "ads_top.html";
	$pagecode = "int";
	if ($_COOKIE['lang'] == 'en') { $url6 = "menu_en.html"; $url7 = "intro_04_en.html"; } else if ($_COOKIE['lang'] == 'th') { $url6 = "menu_th.html"; $url7 = "intro_04_th.html"; } else { $url6 = "menu_jp.html"; $url7 = "intro_04_jp.html"; }
