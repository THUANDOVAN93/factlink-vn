<?php 
	...
	if ($_COOKIE['vlang'] == 'en') { $url6 = "menu-html_en.html"; $url7 = "manual_01_en.html"; } else if ($_COOKIE['vlang'] == 'vn') { $url6 = "menu-html_vn.html"; $url7 = "manual_01_vn.html"; } else { $url6 = "menu-html_jp.html"; $url7 = "manual_01_jp.html"; }
