<?php 
	...
	$url5 = "ads_top.html";
	$pagecode = "mnl";
	if ($_COOKIE['vlang'] == 'en') { $url6 = "menu_en.html"; $url7 = "manual_03_en.html"; } else if ($_COOKIE['vlang'] == 'vn') { $url6 = "menu_vn.html"; $url7 = "manual_03_vn.html"; } else { $url6 = "menu_jp.html"; $url7 = "manual_03_jp.html"; }
