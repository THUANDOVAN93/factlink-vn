<?php 
	...
	$url5 = "ads_top.html";
	$pagecode = "mnl";
	if ($_COOKIE['vlang'] == 'en') { $url6 = "menu_en.html"; $url7 = "manual_05_en.html"; } else if ($_COOKIE['vlang'] == 'vn') { $url6 = "menu_vn.html"; $url7 = "manual_05_vn.html"; } else { $url6 = "menu_jp.html"; $url7 = "manual_05_jp.html"; }
