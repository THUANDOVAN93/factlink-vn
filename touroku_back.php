<?php 
		...
		echo "<meta http-equiv = \"refresh\" content = \"0;URL = touroku.html\">";
	...
	$url5 = "ads_top.html";
	$pagecode = "reg";
	if ($_COOKIE['vlang'] == 'en') { $url6 = "menu_en.html"; $url7 = "register_en.html"; } else if ($_COOKIE['vlang'] == 'vn') { $url6 = "menu_vn.html"; $url7 = "register_vn.html"; } else { $url6 = "menu_jp.html"; $url7 = "register_jp.html"; }
